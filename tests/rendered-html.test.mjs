...
test("ships exploration, deck building, battle and persistence", async () => {
  ...
  assert.match(game, /type="module" src="\.\/merlin-assets\/game\/app\.js\?v=24"/);
  ...
  assert.match(sources.app, /from "\.\/battle\.js\?v=24"/);
  assert.match(sources.exploration, /from "\.\/battle\.js\?v=24"/);
