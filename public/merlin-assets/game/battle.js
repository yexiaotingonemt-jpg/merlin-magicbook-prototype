import { $, ELEMENTS, SCHOOL_ORDER, esc, fixed, pick, randomInt, shuffle, variance } from "./core.js";
import { CARD_BY_ID } from "./cards.js";
import { runtime, state } from "./store.js";
import { attack, cardLevel, costLabel, defense, gainExp, levelScale, mainElement, maxHp, poolCap, saveState, schoolLabel } from "./state.js";
...
export function createEnemies(mode) {
  if (mode === "pvp") {
