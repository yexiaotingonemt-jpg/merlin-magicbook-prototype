...
export function showHelp() {
  showModal(`<h2>玩法说明</h2><p>这是一个可完整游玩的系统原型，用于验证探索、元素经济、组卡与自动战斗的衔接。</p><div class="choice-grid"><article class="choice-button"><h3>1 · 六章探索</h3><p>普通章预先生成有限事件池，场上展示3个事件。每处理1个事件，其他有限事件倒计时减1；正面事件会自燃，怪物与镜像会升级。</p></article><article class="choice-button"><h3>2 · 组卡</h3><p>每次从火、水、风随机选2系：一系抽2张基础牌，另一系抽1张；起始元素各1个，Lv.8达到5元素上限。</p></article><article class="choice-button"><h3>3 · 自动战斗</h3><p>书页不放回随机，全部翻完后洗回。元素足够时自动完整施法，否则发动残响且不消耗元素。</p></article></div><p><b>方差规则：</b>元素效果保留40%–300%偏态方差；最终伤害和治疗再独立乘95%–105%微方差。</p><p><b>继承规则：</b>章内生命继承，进入下一章前补满。重新进入法师塔时，塔内等级、经验、生命、魔法书、咒语收藏与起始元素重置；积分与场外商店属性永久保留。</p>`);
}
